...
interface Dao {
    List<Transction> findTransactionList(@Param("accountId") Long accountId, @Param("gubun") String gubun,
...
public class TransactionRepositoryImpl implements Dao {
    ...
    // outer 조인을 해야 하는지
    @Override
    public List<Transction> findTransactionList(Long accountId, String gubun, Integer page) {
        // JPQL
        String sql = "";
        sql += "select t from Transction t ";
        ...
        TypedQuery<Transction> query = em.createQuery(sql, Transction.class);

...
public class AccountService {
    ...
    public AccountDetailRespDto 계좌상세보기(Long number, Long userId, Integer page) {
        ...
        // 4. 입출금목록보기
        List<Transction> transactionList = transactionRepository.findTransactionList(accountPS.getId(), gubun, page);

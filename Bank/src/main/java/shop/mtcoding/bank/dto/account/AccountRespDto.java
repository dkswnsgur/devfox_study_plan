...
public class AccountRespDto {
    ...
    public static class AccountTransferRespDto {
        ...
        public AccountTransferRespDto(Account account, Transction transaction) {
        ...
        public class TransactionDto {
            ...
            public TransactionDto(Transction transaction) {
    ...
    public static class AccountWithdrawRespDto {
        ...
        public AccountWithdrawRespDto(Account account, Transction transaction) {
            this.id = account.getId();
            this.number = account.getNumber();
            this.balance = account.getBalance();
            this.transaction = new TransactionDto(transaction);
    ...
    public static class AccountDetailRespDto {
        ...
        public AccountDetailRespDto(Account account, List<Transction> transactions) {
            this.id = account.getId();
            this.number = account.getNumber();
            this.balance = account.getBalance();
        ...
        public class TransactionDto {
            ...
            public TransactionDto(Transction transaction, Long accountNumber) {
                this.id = transaction.getId();
                this.gubun = transaction.getGubun().getValue();
                this.amount = transaction.getAmount();
                this.sender = transaction.getSender();

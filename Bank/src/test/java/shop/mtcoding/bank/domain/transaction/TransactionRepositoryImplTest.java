...
public class TransactionRepositoryImplTest extends DummyObject {
    ...
    public void findTransactionList_all_test() throws Exception {
        ...
        // when
        List<Transction> transactionListPS = transactionRepository.findTransactionList(accountId, "ALL",
                0);
    ...
    public void dataJpa_test1() {
        List<Transction> transactionList = transactionRepository.findAll();
    ...
    private void dataSetting() {
        ...
        Transction withdrawTransaction1 = transactionRepository
                .save(newWithdrawTransaction(ssarAccount1, accountRepository));
        Transction depositTransaction1 = transactionRepository
                .save(newDepositTransaction(cosAccount, accountRepository));
        Transction transferTransaction1 = transactionRepository
                .save(newTransferTransaction(ssarAccount1, cosAccount, accountRepository));
        Transction transferTransaction2 = transactionRepository
                .save(newTransferTransaction(ssarAccount1, loveAccount, accountRepository));
        Transction transferTransaction3 = transactionRepository

	...
	<div class="card shadow">
		<div class="card-body">
			...
			<table class="table table-hover" id='board_list'>
				<thead>
					<tr>
						<th class="text-center d-none d-md-table-cell">文番号</th>
						<th class="w-50">タイトル</th>
						<th class="text-center d-none d-md-table-cell">作成者</th>
						<th class="text-center d-none d-md-table-cell">作成日付</th>
					</tr>
				</thead>
				<tbody>
        ...
        <form action="${root}board/main" method="get" class="form-inline">
			...
			<div class="d-none d-md-block">
				<ul class="pagination justify-content-center">
					...
					<c:otherwise>
					<li class="page-item">
						<a href="${root }board/main?board_info_idx=${board_info_idx}&page=${pageBean.prevPage}" class="page-link">以前</a>
					</li>
					</c:otherwise>
					</c:choose>
					...
					<c:otherwise>
					<li class="page-item">
						<a href="${root }board/main?board_info_idx=${board_info_idx}&page=${pageBean.nextPage}" class="page-link">次</a>
					</li>
					</c:otherwise>
					</c:choose>
			...
			<div class="text-right">
				<a href="${root }board/write?board_info_idx=${board_info_idx}" class="btn btn-primary">作文</a>
			</div>
